...
;; Copyright (C) 2019 Damien Merenne
...
(defun dash-docs-seq-insert-after (element place-holder sequence)
    ...
    (let ((e (car sequence)))
      (cons e
            (if (equal place-holder e)
              ...
              (dash-docs-seq-insert-after element place-holder (cdr sequence)))))))

(unless (seq-contains use-package-keywords :dash)
  (setq use-package-keywords
        (dash-docs-seq-insert-after :dash :delight use-package-keywords)))
